import type { CameraConfig, CameraPermissionState, ErrorState } from '../types/index.js';
...
export class CameraManager {
   ...
   */
  async initializeCamera(config?: Partial<CameraConfig>): Promise<MediaStream> {
    try {
  ...
  private async checkCameraPermission(): Promise<void> {
    if ('permissions' in navigator) {
      try {
        ...
        this.permissionState = permission.state as CameraPermissionState;
